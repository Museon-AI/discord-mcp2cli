...
The JSON result uses schema `discord-mcp.catalog-check.v1` and reports 210 tools,
...
| `catalog` | Expose all 210 real tool schemas without credentials or Discord access; execution always returns `CATALOG_ONLY`. |
